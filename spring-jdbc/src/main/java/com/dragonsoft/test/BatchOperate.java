...
public class BatchOperate {
    ...
    @Test
    public void init(){
        jdbcTemplate.update("INSERT INTO T_ACCOUNT VALUES (?,?,?)", IdUtils.getRandomIdByUUID(),"张三",10);
        jdbcTemplate.update("INSERT INTO T_ACCOUNT VALUES (?,?,?)", IdUtils.getRandomIdByUUID(),"李四",20);
        jdbcTemplate.update("INSERT INTO T_ACCOUNT VALUES (?,?,?)", IdUtils.getRandomIdByUUID(),"张三",30);
        jdbcTemplate.update("INSERT INTO T_ACCOUNT VALUES (?,?,?)", IdUtils.getRandomIdByUUID(),"王五",40);
        jdbcTemplate.update("INSERT INTO T_ACCOUNT VALUES (?,?,?)", IdUtils.getRandomIdByUUID(),"赵六",50);
    }
    ...
    @Test
    public void fun1(){
        String batchInsertSql1 = "INSERT INTO T_ACCOUNT VALUES ('0001','测试批量操作',10)";
        String batchInsertSql2 = "INSERT INTO T_ACCOUNT VALUES ('0002','测试批量操作',10)";
    ...
    public void fun2(){
        ...
        List<Account> paramList = new ArrayList<Account>(){{
            add(new Account("00001", "zhangsan", 28.9));
            add(new Account("00002", "lisi", 68.0));
            add(new Account("00003", "wangwu", 58.2));
        }};
